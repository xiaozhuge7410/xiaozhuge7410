...
FourMinWalkDetail.prototype.bind = function(){
    ...
    $('.start-date-form').on('apply.daterangepicker', function(ev, picker) {
        ...
        var bin = $(this).find('input').val()+' 00:00:00';
...
FourMinWalkDetail.prototype.requestPage = function(page,condition,beginTime,endTime,pageSize){
    var _this = this;
    ...
    if(dataList.length==0){
        ...
        for(var i=0;i<dataList.length;i++){
            ...
            if(dataList[i].questionnaireRecordId!=null){
                tableItem +='<td><a class="report-detail" href="4min_walk_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'" data-reportid="'+dataList[i].sportId+'" data-customeruuid="'+dataList[i].uuid+'">报告</a>' +
                    '<a class="recordid-detail" href="../customer/Survey_report_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'"></a></td>'
            }else{
                tableItem += '<td><a class="report-detail" href="4min_walk_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'" data-reportid="'+dataList[i].sportId+'" data-customeruuid="'+dataList[i].uuid+'">报告</a></td>'
            }
            tableItem += '</tr>';
            $(tableItem).appendTo($tbody);
        }
