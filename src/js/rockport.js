...
function rockportReport(){
    this.ajaxLoading = false;
    this.init();
}

rockportReport.prototype.init = function(){
...
rockportReport.prototype.bind = function(){
    var _this = this;
...
rockportReport.prototype.requestPage = function(page,condition,beginTime,endTime,pageSize){
    var _this = this;
    var reqUrl = 'motiondata/getAllUserAerobicInfo';
...
rockportReport.prototype.renderTable = function(data){
    $('.table-mask-box').hide();
    ...
    if(dataList.length==0){
        ...
        for(var i=0;i<dataList.length;i++){
            ...
            if(dataList[i].questionnaireRecordId!=null){
                tableItem +='<td><a class="report-detail" href="rockport_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'" data-reportid="'+dataList[i].sportId+'" data-customeruuid="'+dataList[i].uuid+'">报告</a>' +
                    '<a class="recordid-detail" href="../customer/Survey_report_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'"></a></td>'
            }else{
                tableItem += '<td><a class="report-detail" href="rockport_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'" data-reportid="'+dataList[i].sportId+'" data-customeruuid="'+dataList[i].uuid+'">报告</a></td>'
            }
            tableItem += '</tr>';
            $(tableItem).appendTo($tbody);
        }
...
rockportReport.prototype.initPagination = function(num){
...
rockportReport.prototype.paBind = function(){
    var _this = this;
...
rockportReport.prototype.resetSortType = function(){
    window.localStorage.removeItem('sortType');
};

rockportReport.prototype.theadSortEvent = function(){
    var _this = this;

    var sortTypeDescArr = ['CREATE_TIME_DESC','USER_ID_DESC','NICK_NAME_DESC','SEX_DESC','AGE_DESC','MET_VALUE_DESC'];
    var sortTypeAscArr = ['CREATE_TIME_ASC','USER_ID_ASC','NICK_NAME_ASC','SEX_ASC','AGE_ASC','MET_VALUE_ASC'];
