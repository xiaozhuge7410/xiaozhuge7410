...
function AerobicReport(){
    this.ajaxLoading = false;
    this.init();
}
AerobicReport.prototype.init = function(){
...
AerobicReport.prototype.bind = function(){
    var _this = this;
...
AerobicReport.prototype.requestPage = function(page,condition,beginTime,endTime,pageSize){
    var _this = this;
...
AerobicReport.prototype.renderTable = function(data){
    $('.table-mask-box').hide();
    ...
    if(dataList.length==0){
        ...
        for(var i=0;i<dataList.length;i++){
            ...
            if(dataList[i].questionnaireRecordId!=null){
                tableItem +='<td><a class="report-detail" href="aerobic_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'" data-reportid="'+dataList[i].sportId+'" data-customeruuid="'+dataList[i].uuid+'">报告</a>' +
                    '<a class="recordid-detail" href="../customer/Survey_report_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'"></a></td>'
            }else{
                tableItem += '<td><a class="report-detail" href="aerobic_detail.html" data-recordId="'+dataList[i].questionnaireRecordId+'" data-reportid="'+dataList[i].sportId+'" data-customeruuid="'+dataList[i].uuid+'">报告</a></td>'
            }
            tableItem += '</tr>';
            $(tableItem).appendTo($tbody);
        }
...
AerobicReport.prototype.initPagination = function(num){
...
AerobicReport.prototype.paBind = function(){
    var _this = this;
...
AerobicReport.prototype.resetSortType = function(){
    window.localStorage.removeItem('sortType');
};

AerobicReport.prototype.theadSortEvent = function(){
    var _this = this;

    var sortTypeDescArr = ['CREATE_TIME_DESC','NICK_NAME_DESC','SEX_DESC','AGE_DESC','MET_VALUE_DESC'];
    var sortTypeAscArr = ['CREATE_TIME_ASC','NICK_NAME_ASC','SEX_ASC','AGE_ASC','MET_VALUE_ASC'];
